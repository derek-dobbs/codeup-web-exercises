...
// Make a function named isOdd(number)
    ...
    console.log("Testing the isOdd function:");
    console.log("3 is an odd number? " + isOdd(3));
...
// Make a function named isEven(number)
    ...
    console.log("Testing the isEven function:");
...
// Make a function named identity(input) that returns the input exactly as provided.
    ...
    console.log("Testing the identity function:")
    console.log("The input, 'Hello' should return the same message: " + identity("Hello"));
    console.log("---------------------------------------------------------------------------------------------");
...
//     Make a function named isFive(input)
    ...
    console.log("Testing the isFive() function:");
    console.log("2 is equal to 5? " + isFive(2));
    console.log("5 is equal to 5? " + isFive(5));
    console.log("7 is equal to 5? " + isFive(7));
    console.log("---------------------------------------------------------------------------------------------");
...
// Make a function named addFive(input) that adds five to some input.
    ...
    console.log("Testing the addFive() function: ");
    console.log("2 + 5 = " + addFive(2));
    console.log("3 + 5 = " + addFive(3));
    console.log("4 + 5 = " + addFive(4));
    console.log("---------------------------------------------------------------------------------------------");
...
//     Make a function named isMultipleOfFive(input)
    ...
    console.log("Testing the isMultipleOfFive() function");
    console.log("13 is a multiple of 5: " + isMultipleOfFive(13));
    console.log("15 is a multiple of 5: " + isMultipleOfFive(15));
    console.log("47 is a multiple of 5: " + isMultipleOfFive(47));
    console.log("---------------------------------------------------------------------------------------------");
...
// Make a function named isThree(input)
    ...
    console.log("Testing the isThree() function:");
    console.log("The number 2 = 3 -- " + isThree(2));
    console.log("The number 3 = 3 -- " + isThree(3));
    console.log("The number 4 = 3 -- " + isThree(4));
    console.log("---------------------------------------------------------------------------------------------");
